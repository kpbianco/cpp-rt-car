...
RTFW 0.12's demo implements none of those three options and does not read
`RTFW_PROFILE`.
...
configure or consume the M1–M11 runtime surface, so runtime autotuning remains
invalid.
